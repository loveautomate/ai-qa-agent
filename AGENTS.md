...
- **Example branches:** Real `tests/plans/`, `tests/e2e/`, and/or `tests/api/` — Sauce Demo, Petstore, and combined PRD scenarios (passing UI/API demos). Details in **`BRANCHING.md`**.
